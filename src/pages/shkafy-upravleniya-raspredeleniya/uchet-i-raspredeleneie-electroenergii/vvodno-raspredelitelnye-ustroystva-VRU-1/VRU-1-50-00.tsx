...
export default function VRU15000() {
  const schemaContainer = "flex w-full justify-center border-[1px] border-primary-main bg-white py-2"

  return (
    <>
      <Seo
        title="Распределительная панель ВРУ1-50-00 УХЛ4"
        description="ВРУ1-50-00 - это распределительная панель на 250А без блока автоматического управления освещением БАУО. Предусмотрено размещение двух трехфазных групп. На вводе не установлены рубильники(переключатели)"
      ...
      <Breadcrumbs
        items={[
          ...
          { label: "Распределительная панель ВРУ1-50-00 УХЛ4" },
        ]}
      />
      <PageHeader bgSecondary title="Распределительная панель ВРУ1-50-00 УХЛ4" />
      <Template
        className="pb-[25%] xl:pb-[20%]"
        equipmentImage={
          <Image src="/VRU-1-17-70.jpg" width={249} height={297} alt="Распределительная панель ВРУ1-50-00 УХЛ4" />
        }
      >
        <HeadingText>Назначение</HeadingText>
        <div className="template-container">
          <Paragraph>
            ВРУ1-50-00 - это распределительная панель на 250А без блока автоматического управления освещением БАУО.
        ...
        <div className="template-container border-none">
          <div className={schemaContainer}>
            <Image
              src="/VRU-1-50-00-schema.jpg"
              width={316}
              height={274}
              priority={true}
              alt="Схема первичных соединений ВРУ1-50-00"
            />
          </div>
          <Paragraph>Степень защиты оболочки корпуса IP31(возможно изготовление степенью защиты IP54).</Paragraph>
          <Paragraph>
            Устройство ВРУ 1-50-00 представляет собой электрощит с установленными элементами защиты и управления внутри
