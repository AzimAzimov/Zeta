    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: "Распределительная панель ВРУ1-47-00 УХЛ4" },
        ]}
      />
      <PageHeader bgSecondary title="Распределительная панель ВРУ1-47-00 УХЛ4" />
      <Template
        className="pb-[25%] xl:pb-[20%]"
        equipmentImage={
          <Image src="/VRU-1-17-70.jpg" width={249} height={297} alt="Распределительная панель ВРУ1-47-00 УХЛ4" />
        }
      >
        <HeadingText>Назначение</HeadingText>
        <div className="template-container">
          <Paragraph>
            ВРУ1-47-00 - это распределительная панель на 100А 5 групп, без блока автоматического управления освещением
            БАУО. Предусмотрено размещение двух трехфазных групп. На вводе не установлены рубильники(переключатели). На
        ...
        <div className="template-container border-none">
          <div className={`${schemaContainer} py-6 md:py-4`}>
            <Image
              ...
              height={249}
              priority={true}
              alt="Схема первичных соединений ВРУ1-47-00 УХЛ4"
            />
          </div>
          <Paragraph>Степень защиты оболочки корпуса IP31 (возможно изготовление степенью защиты IP54).</Paragraph>
          <Paragraph>
            Устройство ВРУ 1-47-00 представляет собой электрощит с установленными элементами защиты и управления внутри
